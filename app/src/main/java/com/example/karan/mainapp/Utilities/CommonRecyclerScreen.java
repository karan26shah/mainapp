...
import com.example.karan.mainapp.

import java.util.ArrayList;
import java.util.List;

import static com.example.karan.mainapp.Utilities.CommonRecyclerItem.ItemType.LOADING;
 ...
 /*   public class CommonRecyclerScreen {
    ...
    /*    public void addLoadingMoreAtEnd() {
            try {
                ...
                if (recyclerItems != null && (recyclerItems.size() == 0 || recyclerItems.get(recyclerItems.size() - 1).getItemType() != CommonRecyclerItem.ItemType.LOADING)) {
